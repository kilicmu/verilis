...
# This script generates an installation script for Verilis
# Usage: ./generate_install_script.sh <version> <app_name>

VERSION=$1
APP_NAME=$2

if [ -z "$VERSION" ] || [ -z "$APP_NAME" ]; then
  echo "Usage: $0 <version> <app_name>"
  exit 1
fi
...
chmod +x install.sh
echo "Installation script generated: install.sh"
